...
<xsl:stylesheet 
    ...
    <xsl:param name="directory_name">tillich-lectures-static</xsl:param>
    <xsl:param name="project_title">Edition of Tillich’s Lectures on Religion and Culture</xsl:param>
    <xsl:param name="redmine_id">23501</xsl:param>
    <xsl:param name="project_short_title">Tillich-Lectures</xsl:param>
